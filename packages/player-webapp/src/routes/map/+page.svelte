<script lang="ts">
  ...
  function updateMarkers(locations: AdminLocation[]) {
    ...
    locations.forEach(admin => {
      if (admin.location !== '<encrypted>' && typeof admin.location === 'object') {
        ...
        const marker = L.marker([lat, lng], { icon: adminIcon })
          .addTo(map)
          .bindPopup(`
...
<div class="page">
  <div class="container">
    ...
    <div class="admin-card">
      <div class="card-header">
        ...
        {#if adminLocations.lastUpdate}
          <span class="last-update">Updated {formatTime(adminLocations.lastUpdate)}</span>
        {/if}
      </div>
    ...
    <div class="info-tip">
      ...
      <p>Show your <a href="/profile">profile QR</a> to an admin to get verified!</p>
    </div>
  </div>
</div>
